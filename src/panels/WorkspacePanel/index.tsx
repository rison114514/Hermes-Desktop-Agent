    ...
    <aside className="flex w-[24rem] shrink-0 flex-col border-l border-white/10 bg-[linear-gradient(180deg,rgba(7,10,18,0.95),rgba(15,23,42,0.92))] px-5 py-5">
      <div className="mb-6 flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-white/10 bg-white/5 text-slate-200 transition enabled:hover:border-rose-200/30 enabled:hover:bg-rose-200/10 disabled:cursor-not-allowed disabled:text-slate-600"
          title="刷新工作区上下文"
          aria-label="刷新工作区上下文"
        >
